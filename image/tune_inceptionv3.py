...
nohup python -m image.tune_inceptionv3.py >> tune_inceptionv3.log 2>&1&
"""
...
model.save_weights('data/images_clothes/model/inception_finetuned.h5')  # always save your weights after training or
# during training

"""
Builds model to categorize product based on title. Steps include:
- Loading title and category data
- Cleaning title and category data (based on data_prep.clean titles)
- Creates and save dictionary model in pickle format
...
def convert_category_to_int(df, category_to_int_dict, category='regional_key', ):
    ...
    Returns a dataframe where the categories (str) have been converted to int.
